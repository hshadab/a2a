...
use onnx_tracer::instructions::eq::Eq;

impl<const WORD_SIZE: usize> InstructionLookup<WORD_SIZE> for Eq {
    fn lookup_table(&self) -> Option<LookupTables<WORD_SIZE>> {
        Some(EqualTable.into())
    }
}

impl<const WORD_SIZE: usize> LookupQuery<WORD_SIZE> for Eq {
...
mod test {
    ...
    fn materialize_entry() {
        materialize_entry_test(AtlasOpcode::Eq);
    }
}
